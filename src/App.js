...
//import logoIMG from "./assets/7.jpg";
...
const App = () => {
  ...
  return (
    <>
      ...
      <Layout id="rules" title="This is Title" urlBg={bg}>
        <p>
      ...
      <Layout id="cards" title="Cards" colorBg={`#457aeb`}>
        <div className="flex">
          {
            POKEMONS.map((item) => (
      ...
      <Layout id="about" title="This is Title" urlBg={bg}>
        <p>
          In the game two players face off against one another, one side playing
          as "blue", the other as "red" on a 3x3 grid. Each player has five
          cards in a hand and the aim is to capture the opponent's cards by
